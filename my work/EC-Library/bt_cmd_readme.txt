Bluetooth Command Line Tools 1.2 build 56
© 2010-2012 BluetoothInstaller.com
bct@bluetoothinstaller.com
...
The installer creates "Bluetooth Tools Command Prompt" icon which automatically set the environment variables (PATH) that enable you to easily Bluetooth Command Line Tools without modifying global PATH variable.
...
Thank you for using Bluetooth Command Line Tools.
